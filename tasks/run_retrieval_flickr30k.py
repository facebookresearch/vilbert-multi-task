...
from multimodal_bert.datasets import FlickrRetreivalDatasetTrain, FlickrRetreivalDatasetVal
...
def main():
    ...
    parser.add_argument(
        "--train_file",
        default="data/flick30k/all_data_final_train_2014.jsonline",
        type=str,
        # required=True,
    ...
    parser.add_argument(
        "--val_file",
        default="data/flick30k/all_data_final_val_set0_2014.jsonline",
        type=str,
        help="The input train corpus.",
    )
...
#
    ...
    if args.do_train:
        ...
        train_dset = FlickrRetreivalDatasetTrain('train', args.train_file, image_features_reader, tokenizer)
        eval_dset = FlickrRetreivalDatasetTrain('val', args.val_file, image_features_reader, tokenizer)
        ...
        for name in bert_weight_name:
            ...
            for name in bert_weight_name:
                if 'embeddings' in name:
                    ...
                    if int(layer_num) <= args.fixed_t_layer:
                        bert_weight_name_filtered.append(name)
