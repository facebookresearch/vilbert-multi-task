...
from multimodal_bert.datasets import VisDialDataset
...
def main():
    ...
    parser.add_argument("--features_train_h5path", default="data/coco/coco_trainval.h5")
    parser.add_argument("--features_val_h5path", default="data/coco/coco_trainval.h5")

    parser.add_argument(
        "--instances-train-jsonpath", default="data/VisualDialog/visdial_1.0_train.json"
    )
    parser.add_argument(
        "--instances-val-jsonpath", default="data/VisualDialog/visdial_1.0_val.json"
    )
    ...
    if args.baseline:
        ...
        from multimodal_bert.bert import MultiModalBertForVisDial
    else:
        from multimodal_bert.multi_modal_bert import MultiModalBertForVisDial, BertConfig
    ...
    if args.do_train:
        ...
        image_features_train_reader = ImageFeaturesH5Reader(args.features_train_h5path, True, 36)
        image_features_val_reader = ImageFeaturesH5Reader(args.features_train_h5path, True, 36)

        # train_dset = VisDialDataset(
        #     "train", 
        #     args.instances_train_jsonpath, 
        #     image_features_train_reader, 
        #     tokenizer,
        #     max_caption_length=args.max_seq_length,
        # )

        eval_dset = VisDialDataset(
            "val", 
            args.instances_val_jsonpath, 
            image_features_val_reader, 
            tokenizer,
            max_caption_length=args.max_seq_length,
